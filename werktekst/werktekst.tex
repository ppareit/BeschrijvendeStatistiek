...
\begin{description}
  \item[n] Het aantal gegevens.
  \item[Gemiddelde] Het rekenkundig gemiddelde.
  \item[s] De standaard afwijking.
  \item[Min] De laagste waarde.
  \item[Q1] Het eerste kwartiel.
  \item[Mediaan] De mediaan.
  \item[Q3] Het derde kwartiel.
  \item[Max] De hoogste waarde.
\end{description}
...
\begin{wrapfigure}[11]{l}{0.3\textwidth}
  \includegraphics[width=0.3\textwidth]{boxplot}
\end{wrapfigure}
