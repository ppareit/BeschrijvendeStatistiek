...
\uncover<4->{Tel alle frequenties samen want dan heb je het totale aantal snoepjes en dat is gelijk aan de
steekproefgrootte.}
\end{frame}
...
\pause
Van elk kleur zijn er evenveel snoepjes. Dus elk kleur heeft evenveel kans om gekozen te worden. Er zijn zes kleuren, dus de kans is $\frac{1}{6}$.
\pause
...
\pause
De relatieve frequentie werd berekend uit een steekproef. Een steekproef is een lukraak deel van de volledige populatie. Hoe groter de steekproef, hoe dichter we bij de volledige populatie komen en hoe dichter we bij de theoretische kans komen.
\end{frame}
...
\pause
Neen. Er is fluctuatie bij het vullen van de zakjes en dus zullen de antwoorden niet identiek
...
\pause
Elk zakje kan je beschouwen als een nieuwe steekproef uit dezelfde grote populatie van alle
M\&M’s. Bij een steekproef trek je lukraak en het is dus normaal dat de resultaten van de ene
...
\pause
Neen, want een ander zakje kan een ander aantal blauwe snoepjes bevatten. Een steekproefuitslag is nooit "wiskundig exact"! We kunnen enkel een benadering geven.
\end{frame}
...
\pause
Om twee situaties met elkaar te vergelijken, ga ik met relatieve frequenties werken. Enkel als
ik toevallig even grote subgroepen zou hebben, zou ik ook frequenties kunnen gebruiken.
Voor het staafdiagram met subgroepen plaats ik de kleuren op de x-as en de relatieve
...
\pause
De cijfers van de fabrikant liggen vast, want zij beschrijven het model van de totale
populatie. De cijfers van mijn klas zijn toevallige uitkomsten van een steekproef. Als wij
...
\pause
Op maandag 23 april 2012 hebben we in onze school tijdens de les wiskunde een
onderzoek gedaan naar de kleuren van M\&M-snoepjes. We wilden weten welke kleuren
allemaal voorkwamen en hoe vaak elke kleur voorkomt. Voor dit onderzoek hebben we een
aantal zakjes M\&M gebruik. We hebben ook met de gegevens van de fabrikant rekening gehouden.
...
\pause
Bij het onderzoeken van de kleuren van M\&M’s hebben we vastgesteld dat er in elk zakje
dezelfde kleuren voorkomen, maar niet allemaal in dezelfde hoeveelheid. Dit is te verklaren
omdat zakjes lukraak gevuld worden. Elk zakje kan beschouwd worden als een lukrake
steekproef uit een enorm grote populatie. Als we alle zakjes samenvoegen, dan hebben we
